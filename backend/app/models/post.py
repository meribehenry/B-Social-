...
class Post(db.Model):
    ...
    reactions = db.relationship("PostReaction", backref="post", cascade="all, delete-orphan", passive_deletes=True, lazy="dynamic")
    clicks = db.relationship("Click", backref="post", cascade="all, delete-orphan", passive_deletes=True, lazy="dynamic")
